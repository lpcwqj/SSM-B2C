...
<body>
	...
	<div class="block clearfix">
		...
		<div class="location ared">
			当前位置： <a href="/goods/before?id=0">首页</a> > 购物流程 > 购物车
		</div>
		<div class="blank"></div>
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="ce" items="${cartlist}">
						<tr>
							<td bgcolor="#ffffff" align="center"><a href="/user/goodsDetail?id=${ce.id}" target="_blank">
								<img style="width: 100px; height: 100px;" src="/pic/${ce.gpicture}" border="0" />
							</a><br/><a style="text-decoration: none;" href="/user/goodsDetail?id=${ce.id}" target="_blank" class="f6">${ce.gname}</a></td>
					...
					<tr>
						<td bgcolor="#ffffff" colspan="4" align="right"
							...
							<a href="/cart/continue"> <img src="../../images/before/jxgw.jpg" alt="continue" />
						</a>
						</td>
