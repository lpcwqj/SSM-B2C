					...
					<c:forEach var="mo" items="${myOrder}"> 
						<tr>
							...
							<td align="center" bgcolor="#ffffff">
								<fmt:formatDate value="${mo.orderstate}" pattern="yyyy-MM-dd HH:mm:ss"/>
							</td>
							...
							<td align="center" bgcolor="#ffffff">
							<a style="text-decoration: none;" class="f6" href="/order/orderDetail?ordersn=${mo.id}" target="_blank">详情</a>
							</td>
						</tr>
					</c:forEach>
				</table>
		...
		<div>
			<div class="nFlowBox">
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mf" items="${myFocusGoods}">
						<tr>
