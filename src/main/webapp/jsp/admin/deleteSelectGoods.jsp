...
<body>
	...
	<c:if test="${allGoods.totalCount != 0 }">
		...
		<table border="1" bordercolor="PaleGreen">
			...
			<tr>
				<td colspan="6">
					<input type="button" value="批量删除" onclick="confirmDelete()">
				</td>
			</tr>
			<tr>
				<td colspan="6" align="right">
					...
					<c:if test="${allGoods.currentPage != 1}">
						<a href="/adminGoods/selectGoods?currentPage=1&act=deleteSelect">首页</a>&nbsp;&nbsp;
						<a href="/adminGoods/selectGoods?currentPage=${allGoods.currentPage-1}&act=deleteSelect">上一页</a>&nbsp;&nbsp;
					</c:if>
					<c:if test="${allGoods.currentPage != allGoods.totalPage}">
						<a href="/adminGoods/selectGoods?currentPage=${allGoods.currentPage+1}&act=deleteSelect ">下一页</a>&nbsp;&nbsp;
