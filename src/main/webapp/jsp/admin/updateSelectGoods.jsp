			...
			<tr>
				<td colspan="6" align="right">
					...
					<c:if test="${allGoods.currentPage != 1}">
						<a href="/adminGoods/selectGoods?currentPage=1&act=updateSelect">首页</a>&nbsp;&nbsp;
						<a href="/adminGoods/selectGoods?currentPage=${allGoods.currentPage-1}&act=updateSelect">上一页</a>&nbsp;&nbsp;
					</c:if>
					<c:if test="${allGoods.currentPage != allGoods.totalPage}">
						<a href="/adminGoods/selectGoods?currentPage=${allGoods.currentPage+1}&act=updateSelect ">下一页</a>&nbsp;&nbsp;
						<a href="/adminGoods/selectGoods?currentPage=${allGoods.totalPage}&act=updateSelect">尾页</a>
					</c:if>
				</td>
			</tr> 
		</table>
